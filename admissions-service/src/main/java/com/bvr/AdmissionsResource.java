...
public class AdmissionsResource {
	...
	public DiseaseList getDiseases() {
		//DiseaseList dieases = restTemplate.getForObject("http://localhost:8083/pathology/diseases", DiseaseList.class);
		DiseaseList dieases = restTemplate.getForObject("http://pathology-service/pathology/diseases", DiseaseList.class);
		return dieases;
	}
